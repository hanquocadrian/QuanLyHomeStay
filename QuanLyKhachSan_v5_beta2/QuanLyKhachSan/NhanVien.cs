...
namespace QuanLyKhachSan
{
    public partial class NhanVien : Form
    {
        ...
        CdmNhanVien xl = new CdmNhanVien();
        private int i = -1;
        public NhanVien()
        {
            InitializeComponent();
        ...
        {
            lvwNV.Items.Clear();
            foreach (CNhanVien nv in xl.ArrNV)
            {
        ...
        {
            CNhanVien nv = (CNhanVien)xl.ArrNV[j];
        ...
        private void btnSua_Click_1(object sender, EventArgs e)
        {
            ...
            if (xl.sua(nv))
                ...
                MessageBox.Show("Hết NV or Sai Mã NV", "Error");
        }
        ...
        private void btnXoa_Click_1(object sender, EventArgs e)
        {
            ...
            foreach(int j in lvwNV.SelectedIndices)
            {
                if (xl.xoa(lvwNV.Items[j].Text))
                    hienthi();
                else
                    MessageBox.Show("Hết Data NV or Không tìm thấy Mã để xóa", "Error");
                break;
            }
        }
