    ...
    public partial class DatPhong : Form
    {
        ...
        public void hienthi()
        {
            ...
            foreach (CDatPhong dp  in arrDP)
            {
                ...
                li.SubItems.Add(dp.ThanhTien(timGiaLoaiPhong(dp.Phong.Loaiphong)).ToString());
            }
        }
        ...
        public void hienthiDP(int j)
        {
            ...
            txtThanhTien.Text = dp.ThanhTien(timGiaLoaiPhong(dp.Phong.Loaiphong)).ToString();
        }
        ...
        public int timGiaLoaiPhong(string loaiphong)
        {
            int kq = 0;
            foreach(CPhong p in arrPKS)
            {
