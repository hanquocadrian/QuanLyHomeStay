...
namespace QuanLyKhachSan
{
    ...
    class CDatPhong 
    {
        ...
        //    phong.Sophong = 0;
        //    phong.Loaiphong = "";
        //    m_Ngayden = DateTime.Now;
        //    m_Ngaydi = DateTime.Now;
        }
        ...
        //  truyền cho mình giá từ bên kia qua đây mình sẽ lấy giá đó tính ra
        public float ThanhTien(int giaphong)
        {
            float s;
            s = (float)giaphong * SoNgayO();
            return s;
        }
    }
}
