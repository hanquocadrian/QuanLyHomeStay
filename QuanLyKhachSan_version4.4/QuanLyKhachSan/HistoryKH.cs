    ...
    public partial class HistoryKH : Form
    {
        ...
        public void OpenDP(string filename)
        {
            ...
            try
            {
                ...
                frmmng.Data.ArrDP = (List<CDatPhong>)bf.Deserialize(fs);
                fs.Close();
            }
            catch (Exception)
            {
        ...
        public void OpenKH(string filename)
        {
            ...
            try
            {
                fs = new FileStream(filename, FileMode.Open, FileAccess.Read);
                BinaryFormatter bf = new BinaryFormatter();
                frmmng.Data.ArrKH = (List<CKhachHang>)bf.Deserialize(fs);
                fs.Close();
            }
            catch (Exception)
            {
        ...
        public void OpenLSKH(string filename)
        {
            ...
            try
            {
                fs = new FileStream(filename, FileMode.Open, FileAccess.Read);
                BinaryFormatter bf = new BinaryFormatter();
                frmmng.Data.ArrLS = (List<CHistory>)bf.Deserialize(fs);
                fs.Close();
            }
            catch (Exception)
            {
        ...
        public void SaveLSKH(string filename)
        {
            ...
            try
            {
                ...
                BinaryFormatter bf = new BinaryFormatter();
                bf.Serialize(fs, frmmng.Data.ArrLS);
                fs.Close();
            }
            catch (Exception)
            {
        ...
        {
            CHistory lskh = frmmng.Data.ArrLS[j];
